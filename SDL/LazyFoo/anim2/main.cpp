...
SDL_Surface *sprite_image2 = NULL;
...
load_files()
{
    ...
    //sprite_image2 = load_image( "css-sprites-super-mario-brothers.gif" );
    sprite_image2 = load_image( "css-sprites-super-mario-brothers.png" );
...
main ( int argc, char *argv[] )
{
    ...
    while( quit == false ){
        ...
        if( updown ){
            ...
            //u = 100;
            if(u == 0) u = 100;
            // Improve this method to only update the concerned area.
            SDL_FillRect( screen, NULL, SDL_MapRGB( screen->format, 0, 0, 0 ) );
            //apply_surface( 100, 100, SDL_MapRGB( screen->format, 255, 255, 255 ), screen, &tmp2 );
            //SDL_UpdateRect( screen, 100, 100, 16 ,16 );
            apply_surface( 100, u, sprite_image2, screen, &tmp2 );
            u--;
