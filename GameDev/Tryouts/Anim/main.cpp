    ...
    for(int i=0;i<SCREEN_HEIGHT / 16;i++){
        for(int j=0;j<SCREEN_WIDTH / 16;j++){
            ...
            if( tile_map[(i * (SCREEN_WIDTH / 16)) + j]  == 1 ){ 
                ...
                apply_surface( j * 16, i * 16, bricks, *dest, &bricks_collection[0] );
                //printf("Tile 01\n");
            }else if( tile_map[(i * (SCREEN_WIDTH / 16)) + j]  == 2 ){
                apply_surface( j * 16, i * 16, bricks, *dest, &bricks_collection[1] );
            }else if( tile_map[(i * (SCREEN_WIDTH / 16)) + j]  == 3 ){
                apply_surface( j * 16, i * 16, bricks, *dest, &bricks_collection[2] );
            }
        }
    }
        ...
        while( last_tick < this_tick ){
            ...
            */
            ...
            if( mario.is_jumping && mario.vel_y > 0 ){
                tmp = get_tile_type( tile_x + mario.vel_x, mario.y );
                tmp2 = get_tile_type( tile_x + mario.vel_x + (mario.width / 2), mario.y );
            ...
            //Bottom
            if( mario.is_jumping && mario.vel_y < 0 ){
                tmp = get_tile_type( tile_x + mario.vel_x, mario.y + mario.height );
                tmp2 = get_tile_type( tile_x + mario.vel_x + mario.width + 1, mario.y + mario.height );
                if( tmp == 1 || tmp2 == 1 || tmp == 2 || tmp2 == 2 || tmp == 3 || tmp2 == 3 ){
                    mario.is_jumping = false;
                    mario.vel_y = 0;
...
*/
            if( !mario.is_jumping && mario.vel_y == 0 ){
                if( mario.action == RIGHT ){
                    tmp = get_tile_type( tile_x + 2 , mario.y + mario.vel_y + mario.height );
                    tmp2 = get_tile_type( tile_x + (mario.width / 2) , mario.y + mario.vel_y + mario.height );
                    if( tmp == 0 && tmp2 == 0 ){
                        //printf("Topxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n");
                        mario.vel_y = -1;
                        mario.is_jumping = true;
